...
export default function LoginPage() {
    ...
    return (
        <div className="min-h-screen bg-black flex items-center justify-center p-6 relative overflow-hidden">
            ...
            <div className="w-full max-w-md bg-white/[0.02] backdrop-blur-[40px] border border-white/10 p-10 md:p-12 rounded-3xl relative z-10 shadow-[0_32px_64px_rgba(0,0,0,0.8)]">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    <div>
                        <label className="block text-[10px] font-bold text-white/40 tracking-[0.3em] uppercase mb-2 ml-1">Operative Designation (Email)</label>
                        <input
                            type="email"
                            name="email"
                            required
                            ...
                            placeholder="admin@bdcinema.local"
                        />
                    </div>
                    <div>
                        <label className="block text-[10px] font-bold text-white/40 tracking-[0.3em] uppercase mb-2 ml-1">Access Code (Password)</label>
                        <input
                            type="password"
                            name="password"
                            required
